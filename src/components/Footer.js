                ...
                <div className="mt-8">
                    ...
                    <div className="flex flex-wrap" >
                        <input
                            ...
                            className=" w-full py-2 px-4 lg:rounded-l-lg lg:w-3/4 focus:outline-none"
                        />
                        <button className="bg-yellow-500 text-black py-2 px-4 lg:w-1/4 lg:rounded-r-lg w-full hover:bg-yellow-600 transition duration-300">
                            Subscribe
                        </button>
                    </div>
                </div>
